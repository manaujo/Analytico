...
if (!stripePublishableKey) {
  console.warn(
    "Missing Stripe publishable key - Stripe features will be disabled"
  );
}
...
export const STRIPE_PLANS = {
  monthly: {
    priceId:
      import.meta.env.VITE_STRIPE_MONTHLY_PRICE_ID || "price_monthly_default",
    name: "Plano Mensal",
  ...
  yearly: {
    priceId:
      import.meta.env.VITE_STRIPE_YEARLY_PRICE_ID || "price_yearly_default",
    name: "Plano Anual",
